...
(function() {
    ...
    s.calculateOrderOfMagnitude = function(t) {
      ...
      , y = (s.calculateScaleRange = function(t, i, e, s, o) {
        ...
        u === c && (u += .5,
        c >= .5 && !s ? c -= .5 : u += .5);
        for (var d = Math.abs(u - c), p = x(d), f = Math.ceil(u / (1 * Math.pow(10, p))) * Math.pow(10, p), v = s ? 0 : Math.floor(c / (1 * Math.pow(10, p))) * Math.pow(10, p), S = f - v, C = Math.pow(10, p), y = Math.round(S / C); (y > h || h > 2 * y) && !l; )
            if (y > h)
                C *= 2,
                y = Math.round(S / C),
                y % 1 !== 0 && (l = !0);
    ...
    e.RadialScale = e.Element.extend({
        ...
        setScaleSize: function() {
            ...
            i = 0; i < this.valuesCount; i++)
                ...
                e = this.ctx.measureText(y(this.templateString, {
                    value: this.labels[i]
                })).width + 5,
            ...
            if (this.display) {
                ...
                !this.lineArc) {
                    ...
                    for (var i = this.valuesCount - 1; i >= 0; i--) {
                        var e = null
                          , s = null;
                        if (this.angleLineWidth > 0 && i % this.angleLineInterval === 0 && (e = this.calculateCenterOffset(this.max),
